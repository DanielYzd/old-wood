...
let routes = [{
    ...
    },
    {
        ...
        children: [
            ...
            { path: '/CreativeDesignDetail/:id', component: CreativeDesignDetail, name: 'CreativeDesignDetail' },
            ...
            { path: '/EnginExperimentDetail/:id', component: EnginExperimentDetail, name: 'EnginExperimentDetail' },
            { path: '/GeneralReading', component: GeneralReading, name: 'GeneralReading' },
            { path: '/GeneralReadingDetail/:id', component: GeneralReadingDetail, name: 'GeneralReadingDetail' },
            { path: '/IntelligentEnhancement', component: IntelligentEnhancement, name: 'IntelligentEnhancement' },
            { path: '/IntelligentEnhancementDetail/:id', component: IntelligentEnhancementDetail, name: 'IntelligentEnhancementDetail' },
            { path: '/DreamWorks', component: DreamWorks, name: 'DreamWorks' },
            { path: '/DreamWorksDetail/:id', component: DreamWorksDetail, name: 'DreamWorksDetail' },
